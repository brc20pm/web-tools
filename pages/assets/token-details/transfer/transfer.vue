<template>
	<view class="u-page">
		<view class="u-page__item">
			<u-navbar :fixed="false" title="Transfer B20" height="50px" :safeAreaInsetTop="false" :auto-back="true">
		...
		<view class="transfer">
			...
			<u-button class="btn" :disabled="amount<=0" text="Confirm" type="success" size="large" @click="transfer"
