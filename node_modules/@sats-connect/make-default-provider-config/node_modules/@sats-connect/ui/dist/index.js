...
function Be(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(i, t)) && (e.value = t, e.observers && e.observers.length && V(() => {
    for (let r = 0; r < e.observers.length; r += 1) {
      ...
      l && de.disposed.has(s), (l ? !s.tState : !s.state) && (s.pure ? S.push(s) : I.push(s), s.observers && Ue(s)), l || (s.state = F);
    }
    if (S.length > 1e6)
      throw S = [], new Error();
  }, !1)), t;
...
function vt(e, t, n) {
  ...
  try {
    ...
    return e.pure && (e.state = F, e.owned && e.owned.forEach(ie), e.owned = null), e.updatedAt = n + 1, We(l);
  } finally {
    m = s, w = r;
  }
  (!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? Be(e, i) : e.value = i, e.updatedAt = n);
}
function _e(e, t, n, i = F, r) {
  const s = {
    fn: e,
    state: i,
    updatedAt: null,
...
function te(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    ...
    if (i.sources) {
      const r = i.state;
      r === F ? i !== t && (!i.updatedAt || i.updatedAt < ne) && ee(i) : r === Q && te(i, t);
    }
  }
}
function Ue(e) {
...
function $t(...e) {
  ...
  for (let l = 0; l < e.length; l++) {
    const o = e[l];
    t = t || !!o && me in o, e[l] = typeof o == "function" ? (t = !0, M(o)) : o;
  }
  if (t)
    return new Proxy(
      {
...
function At(e) {
  ...
  return M(_t(() => e.each, e.children, t || void 0));
}
function he(e) {
  const t = e.keyed, n = M(() => e.when, void 0, {
...
function Lt(e) {
  let t = !1;
  const n = (s, l) => (t ? s[1] === l[1] : !s[1] == !l[1]) && s[2] === l[2], i = wt(() => e.children), r = M(
    () => {
      let s = i();
      Array.isArray(s) || (s = [s]);
...
function je(e, t, n, i, r, s) {
  ...
  if (t === "ref")
    ...
    const u = r && t.indexOf(":") > -1 && Mt[t.split(":")[0]];
  ...
  if (e = l && n[0] && n[0].parentNode || e, s === "string" || s === "number")
    ...
    if (Array.isArray(t)) {
      ...
      if (o.length === 0) {
        ...
        c ? n.length === 0 ? Te(e, o, i) : Ft(e, n, o) : (n && D(e), Te(e, o));
      n = o;
    } else if (t.nodeType) {
      if (Array.isArray(n)) {
        if (l)
...
function Nn() {
  ...
  e.id = Ee, document.body.appendChild(e);
}
function zn() {
  const e = He();
  e && e.remove();
...
export {
  ...
  Ee as elementId,
  ge as elementName,
  He as getWalletProviderSelectorElement,
  ke as hasInstallPrompt,
  jn as isInstalled,
  Nn as loadSelector,
  Rn as selectWalletProvider,
  Mn as walletClose,
  In as walletOpen
};
